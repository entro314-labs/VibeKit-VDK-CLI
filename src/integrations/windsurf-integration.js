...
export class WindsurfIntegration extends BaseIntegration {
  ...
  detectUsage() {
    ...
    if (detection.confidence === 'none') {
      detection.recommendations.push('Windsurf not detected. Install from: https://codeium.com/windsurf');
    } else if (detection.confidence === 'low') {
      detection.recommendations.push('Windsurf may be installed but not configured for this project');
      detection.recommendations.push('Run: vdk init --ide-integration to configure Windsurf integration');
      ...
      detection.recommendations.push('Consider leveraging Codeium supercomplete features with custom rules');
    }
